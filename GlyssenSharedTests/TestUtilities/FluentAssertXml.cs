// This will no longer be used when libpalaso moves to NUnit 3.12
// Delete the entire GlyssenSharedTests.TestUtilities folder. This is just a quick fix.
	...
	public class AssertXmlString : AssertXmlCommands
	{
		...
		public void EqualsIgnoreWhitespace(string xml)
		{
            if (DateTime.Now.Year == 2020)
              throw new NotSupportedException("libpalaso needs to be upgraded to use NUnit 3.12.");
