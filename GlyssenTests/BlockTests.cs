...
namespace GlyssenTests
{
	...
	class BlockTests
	{
		...
		public void GetTextAsHtml_ContainsCharactersWhichNeedToBeEscaped()
		{
			...
			const string expected = "The dog&#39;cat says, &lt;&lt;Woof!&gt;&gt; &amp; &quot;Meow.&quot;";
		...
		public void GetTextAsHtml_BlockSplitProvided_InsertsBlockSplit()
		{
			...
			//var outputHtml = block.GetTextAsHtml(true, false, new[] {new BlockSplitData(0, block, "4", 5)});
			//Assert.AreEqual("<div id=\"3\" class=\"scripttext\"><div class=\"splittext\">Text of verse three, part two [2]. " +
			//				"</div></div><sup>4&#160;</sup><div id=\"4\" class=\"scripttext\">Text " + Block.BuildSplitLineHtml(0) + "of vers [sic] four. </div><sup>5&#160;</sup>" +
