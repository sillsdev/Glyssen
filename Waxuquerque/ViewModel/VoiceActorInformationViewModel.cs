...
namespace Glyssen.ViewModel
{
	...
	public class VoiceActorInformationViewModel
	{
		...
		public static DataTable GetVoiceQualityDataTable()
		{
			...
			table.Columns.Add("Name");
			table.Rows.Add(VoiceQuality.Normal, Localizer.GetString("DialogBoxes.VoiceActorInformation.VoiceQuality.Normal", "N - Normal"));
			table.Rows.Add(VoiceQuality.Dramatic, Localizer.GetString("DialogBoxes.VoiceActorInformation.VoiceQuality.Dramatic", "D - Dramatic"));
			table.Rows.Add(VoiceQuality.Authoritative, Localizer.GetString("DialogBoxes.VoiceActorInformation.VoiceQuality.Authoritative", "A - Authoritative/Firm"));
			table.Rows.Add(VoiceQuality.Weak, Localizer.GetString("DialogBoxes.VoiceActorInformation.VoiceQuality.Weak", "W - Weak"));
			table.Rows.Add(VoiceQuality.Suspicious, Localizer.GetString("DialogBoxes.VoiceActorInformation.VoiceQuality.Suspicious", "S - Suspicious"));
			table.Rows.Add(VoiceQuality.Clear, Localizer.GetString("DialogBoxes.VoiceActorInformation.VoiceQuality.Clear", "C - Clear"));
			return table;
		}
