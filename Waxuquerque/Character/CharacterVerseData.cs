		...
		public static string GetCharacterNameForUi(string characterId)
		{
			...
			switch (GetStandardCharacterType(characterId))
			{
				case StandardCharacter.Narrator:
					localizedCharacterId = String.Format(Localizer.GetString("DialogBoxes.AssignCharacterDlg.Narrator", kNarratorAsEnglishCharacterName), GetBookCodeFromStandardCharacterId(characterId));
					break;
				case StandardCharacter.Intro:
					localizedCharacterId = String.Format(Localizer.GetString("DialogBoxes.AssignCharacterDlg.IntroCharacter", kIntroductionAsEnglishCharacterName), GetBookCodeFromStandardCharacterId(characterId));
					break;
				case StandardCharacter.ExtraBiblical:
					localizedCharacterId = String.Format(Localizer.GetString("DialogBoxes.AssignCharacterDlg.ExtraCharacter", kSectionHeadAsEnglishCharacterName), GetBookCodeFromStandardCharacterId(characterId));
					break;
				case StandardCharacter.BookOrChapter:
					localizedCharacterId = String.Format(Localizer.GetString("DialogBoxes.AssignCharacterDlg.BookChapterCharacter", kBookChapterAsEnglishCharacterName), GetBookCodeFromStandardCharacterId(characterId));
					break;
				default:
					localizedCharacterId = Localizer.GetDynamicString(GlyssenInfo.kApplicationId, "CharacterName." + characterId, characterId);
					break;
			}
