...
namespace GlyssenCharacters
{
	...
	{
		/// <summary>
		/// Given a "character" which might not be an "official" character ID, returns a character
		/// ID that is known to speak in the specified location in Scripture, assuming it is
		/// possible to reliably infer a single character based on the given one.
		/// </summary>
		...
		/// this parameter.</param>
		string GetKnownCharacterName(string character, int bookNum, int chapter,
