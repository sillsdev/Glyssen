...
pushd .
MSbuild /target:SignIfPossible /property:teamcity_build_checkoutDir=..\ /property:Configuration="Release" /property:teamcity_dotnet_nunitlauncher_msbuild_task="notthere" /property:Platform=x64 /property:GitVersion_SemVer="6.0.7-local" /property:GitVersion_MajorMinorPatch="6.0.7"
popd
PAUSE
