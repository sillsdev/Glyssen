...
MSbuild /target:Test /property:Configuration="Release" /property:Platform=x64 /property:ExtraExcludeCategories="SkipOnTeamCity" /property:SemVer="1.3.7-local" /property:MajorMinorPatch="1.3.7"
popd
PAUSE
