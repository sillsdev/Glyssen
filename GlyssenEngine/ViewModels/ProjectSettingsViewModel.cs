	...
	public class ProjectSettingsViewModel
	{
		...
		public ProjectSettingsViewModel(Project project)
		{
			...
			foreach (var book in multiChapterBooks)
			{
				...
				if (chapterBlocks.Any())
				{
					...
					if (chapterBlocks.Count > 1)
					{
						...
						if (title != null)
							ExampleTitleForMultipleChapterBook = title.GetText(false);
					}
					break;
				}
			}
			...
			if (singleChapterBook != null)
			{
				...
				if (title != null)
					ExampleTitleForSingleChapterBook = title.GetText(false);
			}
		}
		...
		public string ParatextProjectName => Project.ParatextProjectName;
		public bool IsLiveParatextProject => Project.IsLiveParatextProject;
		...
		public string ExampleTitleForMultipleChapterBook { get; }

		public string ExampleTitleForSingleChapterBook { get; }
