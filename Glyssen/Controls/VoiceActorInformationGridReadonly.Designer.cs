...
{
	partial class VoiceActorInformationGridReadonly
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.ActorQuality = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.ActorName.FillWeight = 200F;
			...
			// ActorGender
			// 
			this.ActorGender.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.DisplayedCells;
			...
			this.ActorGender.ReadOnly = true;
			this.ActorGender.Resizable = System.Windows.Forms.DataGridViewTriState.True;
			this.ActorGender.Width = 342;
			// 
			// ActorAge
			// 
			this.ActorAge.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.DisplayedCells;
			...
			this.ActorAge.ReadOnly = true;
			this.ActorAge.Resizable = System.Windows.Forms.DataGridViewTriState.True;
			this.ActorAge.Width = 369;
			// 
			// ActorQuality
			// 
			this.ActorQuality.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.DisplayedCells;
			...
			this.ActorStatus.ReadOnly = true;
        ...
        "nGrid2");
			...
			this.Name = "VoiceActorInformationGridReadonly";
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn ActorGender;
		private System.Windows.Forms.DataGridViewTextBoxColumn ActorAge;
		private System.Windows.Forms.DataGridViewTextBoxColumn ActorQuality;
