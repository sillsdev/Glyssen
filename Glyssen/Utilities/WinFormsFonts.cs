...
namespace Glyssen.Utilities
{
	...
	{
		public void InstallIfNecessary(string fontFamily, string languageFolder, bool fontInstallationAttempted)
		{
			if (fontInstallationAttempted || FontInstalled(fontFamily))
				return;
