...
namespace Glyssen.Dialogs
{
	partial class VoiceActorInformationDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblActorsEnteredSoFar, Glyssen.Utilities.GlyssenColors.BackColor);
			this.tableLayoutPanel1.SetColumnSpan(this.m_lblActorsEnteredSoFar, 3);
			this.glyssenColorPalette.SetForeColor(this.m_lblActorsEnteredSoFar, Glyssen.Utilities.GlyssenColors.ForeColor);
    ...
    ".";
			...
			this.glyssenColorPalette.SetBackColor(this.m_btnCancelClose, Glyssen.Utilities.GlyssenColors.BackColor);
			this.m_btnCancelClose.DialogResult = System.Windows.Forms.DialogResult.Cancel;
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_btnCancelClose, Glyssen.Utilities.GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetForeColor(this.m_btnCancelClose, Glyssen.Utilities.GlyssenColors.ForeColor);
