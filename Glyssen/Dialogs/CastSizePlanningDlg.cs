...
namespace Glyssen.Dialogs
{
	public partial class CastSizePlanningDlg : Form
	{
		...
		{
			var actors = m_viewModel.GetCastSizeRowValues(m_viewModel.CastSizeOption);
			m_tblNarratorWarning.Visible = ((m_maleNarrators.Value > actors.Male) || (m_femaleNarrators.Value > actors.Female));
