...
namespace Glyssen.Dialogs
{
	public class ExportViewModel
	{
		...
		internal string ActorDirectory
		{
			get
			{
				return Path.Combine(DefaultDirectory, FileNameWithoutExtension + " Voice Actors");
			}
		}
		...
		internal string BookDirectory
		{
			get
			{
				return Path.Combine(Path.GetDirectoryName(FullFileName), Path.GetFileNameWithoutExtension(FullFileName) + " Books");
			}
		}
