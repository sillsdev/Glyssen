...
namespace Glyssen.Dialogs
{
	public partial class ScriptureRangeSelectionDlg : Form
	{
		...
		private void SetupDropdownHeaderCells()
		{
			...
			m_ntBooksGrid.Columns[2].HeaderCell = CreateDropdownHeaderCell(columnOptions);
			m_ntBooksGrid.Columns[3].HeaderCell = CreateDropdownHeaderCell(columnOptions);
			m_otBooksGrid.Columns[2].HeaderCell = CreateDropdownHeaderCell(columnOptions);
			m_otBooksGrid.Columns[3].HeaderCell = CreateDropdownHeaderCell(columnOptions);
		}

		private DataGridViewDropdownColumnHeaderCell CreateDropdownHeaderCell(SortedList<int, string> columnOptions)
		{
			var cell = new DataGridViewDropdownColumnHeaderCell(m_ntBooksGrid.Columns[2].HeaderCell, columnOptions);
