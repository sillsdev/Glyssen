namespace Glyssen.Dialogs
{
	partial class SplitCharacterGroupDlg
	{
		...
		private void InitializeComponent()
		{
			...
			// m_listboxExisting
			// 
			this.glyssenColorPalette.SetBackColor(this.m_listboxExisting, Glyssen.Utilities.GlyssenColors.BackColor);
			this.m_listboxExisting.Dock = System.Windows.Forms.DockStyle.Fill;
			this.glyssenColorPalette.SetForeColor(this.m_listboxExisting, Glyssen.Utilities.GlyssenColors.ForeColor);
			...
			// m_listboxNew
			// 
			this.glyssenColorPalette.SetBackColor(this.m_listboxNew, Glyssen.Utilities.GlyssenColors.BackColor);
			this.m_listboxNew.Dock = System.Windows.Forms.DockStyle.Fill;
			this.glyssenColorPalette.SetForeColor(this.m_listboxNew, Glyssen.Utilities.GlyssenColors.ForeColor);
