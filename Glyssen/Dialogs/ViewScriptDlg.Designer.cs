namespace Glyssen.Dialogs
{
	partial class ViewScriptDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_L10NSharpExtender.SetLocalizingId(this.m_exportMenuItem, "DialogBoxes.ViewScriptDlg.ExportMenuItem");
			this.m_exportMenuItem.Name = "m_exportMenuItem";
			this.m_exportMenuItem.Size = new System.Drawing.Size(107, 22);
			...
			this.m_btnClose.Location = new System.Drawing.Point(486, 10);
			...
			this.m_dataGridView.Size = new System.Drawing.Size(565, 350);
			...
			this.m_tableLayout.Controls.Add(this.m_flowLayout, 0, 1);
			...
			// m_flowLayout
			// 
			this.m_flowLayout.AutoSize = true;
			this.m_flowLayout.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			this.glyssenColorPalette.SetBackColor(this.m_flowLayout, Glyssen.Utilities.GlyssenColors.BackColor);
			this.m_flowLayout.Controls.Add(this.m_btnClose);
			this.m_flowLayout.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.m_flowLayout.FlowDirection = System.Windows.Forms.FlowDirection.RightToLeft;
			this.glyssenColorPalette.SetForeColor(this.m_flowLayout, Glyssen.Utilities.GlyssenColors.Default);
			this.m_flowLayout.Location = new System.Drawing.Point(0, 356);
			this.m_flowLayout.Margin = new System.Windows.Forms.Padding(0);
			this.m_flowLayout.Name = "m_flowLayout";
			this.m_flowLayout.Size = new System.Drawing.Size(571, 43);
			this.m_flowLayout.TabIndex = 0;
			this.glyssenColorPalette.SetUsePaletteColors(this.m_flowLayout, false);
			// 
			// ViewScriptDlg
			// 
