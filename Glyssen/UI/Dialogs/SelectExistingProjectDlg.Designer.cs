...
namespace Glyssen.UI.Dialogs
{
    ...
    " existing project, select it and click OK.";
			...
			this.glyssenColorPalette.SetActiveLinkColor(this.m_linkCreateNewProject, GlyssenColors.ActiveLinkColor);
			this.m_linkCreateNewProject.AutoSize = true;
			this.glyssenColorPalette.SetBackColor(this.m_linkCreateNewProject, GlyssenColors.BackColor);
			this.m_linkCreateNewProject.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(73)))), ((int)(((byte)(108)))));
			this.glyssenColorPalette.SetDisabledLinkColor(this.m_linkCreateNewProject, GlyssenColors.DisabledLinkColor);
			this.m_linkCreateNewProject.DisabledLinkColor = System.Drawing.Color.FromArgb(((int)(((byte)(133)))), ((int)(((byte)(133)))), ((int)(((byte)(133)))));
			this.glyssenColorPalette.SetForeColor(this.m_linkCreateNewProject, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetLinkColor(this.m_linkCreateNewProject, GlyssenColors.LinkColor);
			...
			this.glyssenColorPalette.SetVisitedLinkColor(this.m_linkCreateNewProject, GlyssenColors.VisitedLinkColor);
