...
namespace Glyssen.UI.Dialogs
{
    ...
    "aracter.";
			...
			// m_cmbGender
			// 
			this.glyssenColorPalette.SetBackColor(this.m_cmbGender, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_cmbGender, GlyssenColors.ForeColor);
			...
			// m_cmbAge
			// 
			this.glyssenColorPalette.SetBackColor(this.m_cmbAge, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_cmbAge, GlyssenColors.ForeColor);
