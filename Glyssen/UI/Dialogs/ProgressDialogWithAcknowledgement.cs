...
namespace Glyssen.UI.Dialogs
{
	...
	public class ProgressDialogWithAcknowledgement : Form
	{
		...
		private GlyssenColorPalette m_glyssenColorPalette;
		...
		private void InitializeComponent()
		{
			...
			this.m_glyssenColorPalette = new GlyssenColorPalette();
			...
			this.m_glyssenColorPalette.SetForeColor(this.m_statusLabel, GlyssenColors.ForeColor);
			...
			this.m_glyssenColorPalette.SetForeColor(this.m_progressLabel, GlyssenColors.ForeColor);
			...
			this.m_glyssenColorPalette.SetForeColor(this.m_overviewLabel, GlyssenColors.ForeColor);
			...
			this.m_glyssenColorPalette.SetBackColor(this.m_tableLayout, GlyssenColors.BackColor);
			...
			this.m_glyssenColorPalette.SetForeColor(this.m_tableLayout, GlyssenColors.Default);
			...
			this.m_glyssenColorPalette.SetBackColor(this.m_buttonPanel, GlyssenColors.BackColor);
			...
			this.m_glyssenColorPalette.SetForeColor(this.m_buttonPanel, GlyssenColors.Default);
			...
			this.m_glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_okButton, GlyssenColors.ForeColor);
			this.m_glyssenColorPalette.SetForeColor(this.m_okButton, GlyssenColors.ForeColor);
			...
			this.m_glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_cancelButton, GlyssenColors.ForeColor);
			this.m_glyssenColorPalette.SetForeColor(this.m_cancelButton, GlyssenColors.ForeColor);
			...
			this.m_glyssenColorPalette.SetBackColor(this.m_cancelLink, GlyssenColors.BackColor);
			...
			this.m_glyssenColorPalette.SetDisabledLinkColor(this.m_cancelLink, GlyssenColors.DisabledLinkColor);
			this.m_cancelLink.ForeColor = System.Drawing.SystemColors.WindowText;
			this.m_glyssenColorPalette.SetForeColor(this.m_cancelLink, GlyssenColors.ForeColor);
			this.m_cancelLink.LinkColor = System.Drawing.SystemColors.HotTrack;
			this.m_glyssenColorPalette.SetLinkColor(this.m_cancelLink, GlyssenColors.LinkColor);
			...
			this.AutoSize = true;
			this.m_glyssenColorPalette.SetBackColor(this, GlyssenColors.BackColor);
			this.ClientSize = new System.Drawing.Size(468, 139);
			this.ControlBox = false;
			this.Controls.Add(this.m_tableLayout);
			this.m_glyssenColorPalette.SetForeColor(this, GlyssenColors.Default);
