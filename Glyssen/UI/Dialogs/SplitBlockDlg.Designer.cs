...
namespace Glyssen.UI.Dialogs
{
	partial class SplitBlockDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_blocksDisplayBrowser = new Browser();
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblInvalidSplitLocation, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_lblInvalidSplitLocation, GlyssenColors.Warning);
			...
			this.glyssenColorPalette.SetBackColor(this.m_blocksDisplayBrowser, GlyssenColors.BackColor);
			this.m_blocksDisplayBrowser.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.glyssenColorPalette.SetForeColor(this.m_blocksDisplayBrowser, GlyssenColors.ForeColor);
