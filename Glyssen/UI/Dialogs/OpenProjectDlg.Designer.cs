...
namespace Glyssen.UI.Dialogs
{
	partial class OpenProjectDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_listExistingProjects = new ExistingProjectsList();
			...
			this.glyssenColorPalette.SetBackColor(this.lblExistingProject, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.lblExistingProject, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetActiveLinkColor(this.m_linkTextReleaseBundle, GlyssenColors.ActiveLinkColor);
			this.m_linkTextReleaseBundle.AutoSize = true;
			this.glyssenColorPalette.SetBackColor(this.m_linkTextReleaseBundle, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetDisabledLinkColor(this.m_linkTextReleaseBundle, GlyssenColors.DisabledLinkColor);
			this.glyssenColorPalette.SetForeColor(this.m_linkTextReleaseBundle, GlyssenColors.ForeColor);
			this.m_linkTextReleaseBundle.ForeColor = System.Drawing.SystemColors.WindowText;
			this.glyssenColorPalette.SetLinkColor(this.m_linkTextReleaseBundle, GlyssenColors.LinkColor);
			...
			this.glyssenColorPalette.SetVisitedLinkColor(this.m_linkTextReleaseBundle, GlyssenColors.VisitedLinkColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_chkShowInactiveProjects, GlyssenColors.BackColor);
			this.m_chkShowInactiveProjects.FlatAppearance.BorderColor = System.Drawing.SystemColors.WindowText;
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_chkShowInactiveProjects, GlyssenColors.ForeColor);
			this.m_chkShowInactiveProjects.ForeColor = System.Drawing.SystemColors.WindowText;
			this.glyssenColorPalette.SetForeColor(this.m_chkShowInactiveProjects, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_listExistingProjects, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_listExistingProjects, GlyssenColors.ForeColor);
		...
		private ExistingProjectsList m_listExistingProjects;
