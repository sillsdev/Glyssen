...
namespace Glyssen.UI.Dialogs
{
	partial class CastSizePlanningDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_castSizePlanningOptions = new CastSizePlanningOptions();
			...
			this.m_lblWarningSuboptimalNarratorsForNarrationByAuthor = new System.Windows.Forms.Label();
			...
			this.glyssenColorPalette.SetActiveLinkColor(this.m_linkAbout, GlyssenColors.ActiveLinkColor);
			this.m_linkAbout.AutoSize = true;
			this.glyssenColorPalette.SetBackColor(this.m_linkAbout, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetDisabledLinkColor(this.m_linkAbout, GlyssenColors.DisabledLinkColor);
			this.m_linkAbout.ForeColor = System.Drawing.SystemColors.WindowText;
			this.glyssenColorPalette.SetForeColor(this.m_linkAbout, GlyssenColors.ForeColor);
			this.m_linkAbout.LinkColor = System.Drawing.SystemColors.HotTrack;
			this.glyssenColorPalette.SetLinkColor(this.m_linkAbout, GlyssenColors.LinkColor);
			...
			this.glyssenColorPalette.SetVisitedLinkColor(this.m_linkAbout, GlyssenColors.VisitedLinkColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblStartingOver, GlyssenColors.BackColor);
			this.m_lblStartingOver.Dock = System.Windows.Forms.DockStyle.Top;
			this.glyssenColorPalette.SetForeColor(this.m_lblStartingOver, GlyssenColors.ForeColor);
    ...
    "list of \"Roles for Voice Actors\" will be replaced by a newly generated list.";
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblProjectSummary, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_lblProjectSummary, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblRecordingTime, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_lblRecordingTime, GlyssenColors.ForeColor);
			...
			// m_linkMoreInfo
			// 
			this.glyssenColorPalette.SetActiveLinkColor(this.m_linkMoreInfo, GlyssenColors.ActiveLinkColor);
			this.m_linkMoreInfo.ActiveLinkColor = System.Drawing.SystemColors.HotTrack;
			this.m_linkMoreInfo.AutoSize = true;
			this.glyssenColorPalette.SetBackColor(this.m_linkMoreInfo, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetDisabledLinkColor(this.m_linkMoreInfo, GlyssenColors.DisabledLinkColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_linkMoreInfo, GlyssenColors.ForeColor);
			this.m_linkMoreInfo.LinkColor = System.Drawing.SystemColors.HotTrack;
			this.glyssenColorPalette.SetLinkColor(this.m_linkMoreInfo, GlyssenColors.LinkColor);
			...
			this.glyssenColorPalette.SetVisitedLinkColor(this.m_linkMoreInfo, GlyssenColors.VisitedLinkColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_rbSingleNarrator, GlyssenColors.BackColor);
			this.m_rbSingleNarrator.FlatAppearance.BorderColor = System.Drawing.SystemColors.WindowText;
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_rbSingleNarrator, GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetForeColor(this.m_rbSingleNarrator, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_rbAuthorNarrator, GlyssenColors.BackColor);
			this.m_rbAuthorNarrator.FlatAppearance.BorderColor = System.Drawing.SystemColors.WindowText;
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_rbAuthorNarrator, GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetForeColor(this.m_rbAuthorNarrator, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_rbCustomNarrator, GlyssenColors.BackColor);
			this.m_rbCustomNarrator.FlatAppearance.BorderColor = System.Drawing.SystemColors.WindowText;
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_rbCustomNarrator, GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetForeColor(this.m_rbCustomNarrator, GlyssenColors.ForeColor);
			...
			// m_maleNarrators
			// 
			this.glyssenColorPalette.SetBackColor(this.m_maleNarrators, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_maleNarrators, GlyssenColors.Default);
			...
			// m_femaleNarrators
			// 
			this.glyssenColorPalette.SetBackColor(this.m_femaleNarrators, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_femaleNarrators, GlyssenColors.Default);
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblWorkDistributed, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_lblWorkDistributed, GlyssenColors.ForeColor);
			...
			this.m_l10NSharpExtender.SetLocalizationComment(this.label5, "This is the first part of the instructions. The following line will display the n" +
        "ame of the \"Voice Actor List\" dialog box.");
			...
			this.m_l10NSharpExtender.SetLocalizationComment(this.label6, "This is the second part of the instructions (following the line which displays th" +
        "e name of the \"Voice Actor List\" dialog box).");
			...
			this.glyssenColorPalette.SetBackColor(this.m_castSizePlanningOptions, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_castSizePlanningOptions, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblWhenYouClick, GlyssenColors.BackColor);
			this.m_lblWhenYouClick.Dock = System.Windows.Forms.DockStyle.Top;
			this.glyssenColorPalette.SetForeColor(this.m_lblWhenYouClick, GlyssenColors.ForeColor);
    ...
    " the number of voice actors selected above.";
			...
			this.glyssenColorPalette.SetBackColor(this.m_btnGenerate, GlyssenColors.BackColor);
			this.m_btnGenerate.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_btnGenerate, GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetForeColor(this.m_btnGenerate, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblNarratorWarning, GlyssenColors.BackColor);
			this.m_lblNarratorWarning.Dock = System.Windows.Forms.DockStyle.Right;
			this.glyssenColorPalette.SetForeColor(this.m_lblNarratorWarning, GlyssenColors.ForeColor);
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.m_imgNarratorWarning, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_imgNarratorWarning, GlyssenColors.ForeColor);
			...
			// 
			// m_lblWarningSuboptimalNarratorsForNarrationByAuthor
			// 
			this.m_lblWarningSuboptimalNarratorsForNarrationByAuthor.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.m_lblWarningSuboptimalNarratorsForNarrationByAuthor.BackColor = System.Drawing.SystemColors.Control;
			this.glyssenColorPalette.SetBackColor(this.m_lblWarningSuboptimalNarratorsForNarrationByAuthor, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_lblWarningSuboptimalNarratorsForNarrationByAuthor, GlyssenColors.Warning);
			...
			this.m_lblWarningSuboptimalNarratorsForNarrationByAuthor.TabIndex = 2;
			this.m_lblWarningSuboptimalNarratorsForNarrationByAuthor.Text = "For best results, set the number of narrators to at least {0}.";
			this.m_lblWarningSuboptimalNarratorsForNarrationByAuthor.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.glyssenColorPalette.SetUsePaletteColors(this.m_lblWarningSuboptimalNarratorsForNarrationByAuthor, true);
			this.m_lblWarningSuboptimalNarratorsForNarrationByAuthor.Visible = false;
			// 
			// m_tableLayoutStartingOver
			// 
			this.m_tableLayoutStartingOver.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			this.glyssenColorPalette.SetBackColor(this.m_tableLayoutStartingOver, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_tableLayoutStartingOver, GlyssenColors.Default);
			...
			this.glyssenColorPalette.SetBackColor(this.m_flowLayoutPanel1, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_flowLayoutPanel1, GlyssenColors.Default);
			...
			// m_layoutNarrators
			// 
			this.m_layoutNarrators.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.m_layoutNarrators.AutoSize = true;
			this.m_layoutNarrators.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			this.glyssenColorPalette.SetBackColor(this.m_layoutNarrators, GlyssenColors.BackColor);
			this.m_layoutNarrators.ColumnCount = 3;
			this.m_layoutNarrators.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.m_layoutNarrators.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.m_layoutNarrators.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 100F));
			...
			this.m_layoutNarrators.Controls.Add(this.m_lblWarningSuboptimalNarratorsForNarrationByAuthor, 2, 0);
			this.glyssenColorPalette.SetForeColor(this.m_layoutNarrators, GlyssenColors.Default);
			...
			this.m_layoutNarrators.Size = new System.Drawing.Size(535, 66);
			...
			this.glyssenColorPalette.SetBackColor(this.m_layoutMaleFemale, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_layoutMaleFemale, GlyssenColors.Default);
			...
			this.glyssenColorPalette.SetBackColor(this.m_flowLayoutPanel3, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_flowLayoutPanel3, GlyssenColors.Default);
			...
			this.glyssenColorPalette.SetBackColor(this.m_flowLayoutPanel5, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_flowLayoutPanel5, GlyssenColors.Default);
			...
			this.glyssenColorPalette.SetBackColor(this.m_tblNarratorWarning, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_tblNarratorWarning, GlyssenColors.Default);
			...
			// m_flowLayoutPanel4
			// 
			this.glyssenColorPalette.SetBackColor(this.m_flowLayoutPanel4, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_flowLayoutPanel4, GlyssenColors.Default);
			...
			this.glyssenColorPalette.SetBackColor(this.m_flowLayoutPanel2, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_flowLayoutPanel2, GlyssenColors.Default);
		...
		private CastSizePlanningOptions m_castSizePlanningOptions;
		...
		private System.Windows.Forms.Label m_lblWarningSuboptimalNarratorsForNarrationByAuthor;
	}
}