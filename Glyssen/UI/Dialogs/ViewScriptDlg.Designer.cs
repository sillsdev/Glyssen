...
namespace Glyssen.UI.Dialogs
{
	partial class ViewScriptDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_exportButton = new MenuButton();
			...
			this.glyssenColorPalette.SetBackColor(this.m_dataGridView, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_dataGridView, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_btnClose, GlyssenColors.BackColor);
			this.m_btnClose.DialogResult = System.Windows.Forms.DialogResult.OK;
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_btnClose, GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetForeColor(this.m_btnClose, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblLoading, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_lblLoading, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_exportButton, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_exportButton, GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetForeColor(this.m_exportButton, GlyssenColors.ForeColor);
			...
			//
			this.glyssenColorPalette.SetBackColor(this.m_exportContextMenuStrip, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_exportContextMenuStrip, GlyssenColors.Default);
			...
			//
			this.glyssenColorPalette.SetBackColor(this.m_exportToSpreadsheetMenuItem, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_exportToSpreadsheetMenuItem, GlyssenColors.ForeColor);
			...
			//
			this.glyssenColorPalette.SetBackColor(this.m_exportToHearThisToolStripMenuItem, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_exportToHearThisToolStripMenuItem, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_tableLayout, GlyssenColors.Default);
			...
			this.glyssenColorPalette.SetBackColor(this.m_subTableLayout, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_subTableLayout, GlyssenColors.Default);
		...
		private MenuButton m_exportButton;
