...
namespace Glyssen.UI.Dialogs
{
	partial class UnappliedSplitsDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.glyssenColorPalette.SetBackColor(this.m_btnCopyToClipboard, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_btnCopyToClipboard, GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetForeColor(this.m_btnCopyToClipboard, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_browser, GlyssenColors.BackColor);
			this.m_browser.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.glyssenColorPalette.SetForeColor(this.m_browser, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_checkFinished, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_checkFinished, GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetForeColor(this.m_checkFinished, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_checkDeleteData, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_checkDeleteData, GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetForeColor(this.m_checkDeleteData, GlyssenColors.ForeColor);
