...
{
	/// <summary>
	/// Represents the hosted Multi-Column Combo Box control in a <see cref="T:Glyssen.UI.DataGridViewMultiColumnComboBoxCell"/>.
	...
	public class DataGridViewMultiColumnComboBoxEditingControl : DataGridViewComboBoxEditingControl
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Glyssen.UI.Controls.DataGridViewMultiColumnComboBoxEditingControl"/> class.
		/// </summary>
