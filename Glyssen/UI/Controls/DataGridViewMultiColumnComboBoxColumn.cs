...
{
	/// <summary>
	/// Represents a column of <see cref="T:Glyssen.UI.Controls.DataGridViewMultiColumnComboBoxColumn"/> objects.
	...
	public class DataGridViewMultiColumnComboBoxColumn : DataGridViewComboBoxColumn
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Glyssen.UI.Controls.DataGridViewMultiColumnComboBoxColumn"/> class to the default state.
		/// </summary>
		...
		///
		/// <returns>
		/// A <see cref="T:System.Windows.Forms.DataGridViewCell"/> that all other cells in the column are modeled after. The default value is a new <see cref="T:Glyssen.UI.Controls.DataGridViewMultiColumnComboBoxCell"/>.
		/// </returns>
		/// <exception cref="T:System.InvalidCastException">When setting this property to a value that is not of type <see cref="T:Glyssen.UI.Controls.DataGridViewMultiColumnComboBoxCell"/>. </exception><filterpriority>1</filterpriority>
		[Browsable(false)]
		...
		///
		/// <returns>
		/// An <see cref="T:System.Object"/> that represents the cloned <see cref="T:Glyssen.UI.Controls.DataGridViewMultiColumnComboBoxColumn"/>.
		/// </returns>
