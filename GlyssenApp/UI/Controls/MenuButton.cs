...
{
	/// <summary>
	/// A button which shows a dropdown arrow and displays a context menu when clicked.
	/// See https://stackoverflow.com/questions/10803184/windows-forms-button-with-drop-down-menu
	/// </summary>
