...
namespace GlyssenApp.UI.Dialogs
{
	partial class ScriptureRangeSelectionDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.glyssenColorPalette.SetBackColor(this.m_ntBooksGrid, GlyssenColors.BackColor);
            ...
            this.MultiVoice});
			this.glyssenColorPalette.SetForeColor(this.m_ntBooksGrid, GlyssenColors.ForeColor);
    ...
    "Actors";
			...
			this.glyssenColorPalette.SetBackColor(this.m_checkBoxNewTestament, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_checkBoxNewTestament, GlyssenColors.ForeColor);
			this.m_checkBoxNewTestament.ForeColor = System.Drawing.SystemColors.WindowText;
			this.glyssenColorPalette.SetForeColor(this.m_checkBoxNewTestament, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_checkBoxOldTestament, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_checkBoxOldTestament, GlyssenColors.ForeColor);
			this.m_checkBoxOldTestament.ForeColor = System.Drawing.SystemColors.WindowText;
			this.glyssenColorPalette.SetForeColor(this.m_checkBoxOldTestament, GlyssenColors.ForeColor);
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.glyssenColorPalette.SetBackColor(this.m_otBooksGrid, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_otBooksGrid, GlyssenColors.ForeColor);
