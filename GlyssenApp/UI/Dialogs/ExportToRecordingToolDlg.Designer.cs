...
namespace GlyssenApp.UI.Dialogs
{
	partial class ExportToRecordingToolDlg
	{
		...
		private void InitializeComponent()
		{
			...
			// m_btnBrowse
			// 
			this.glyssenColorPalette.SetBackColor(this.m_btnBrowse, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_btnBrowse, GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetForeColor(this.m_btnBrowse, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_fileNameTextBox, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_fileNameTextBox, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblImportant, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_lblImportant, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblWarning, GlyssenColors.BackColor);
			this.m_tableLayoutPanelMan.SetColumnSpan(this.m_lblWarning, 2);
			this.glyssenColorPalette.SetForeColor(this.m_lblWarning, GlyssenColors.ForeColor);
