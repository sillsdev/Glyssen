namespace GlyssenApp.UI.Dialogs
{
	partial class AddCharacterDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_pnlCharacterAndDeliverySelection.ColumnCount = 2;
			...
			this.m_pnlCharacterAndDeliverySelection.Controls.Add(this.m_lblCharacter, 0, 0);
			this.m_pnlCharacterAndDeliverySelection.Controls.Add(this.m_llMoreDel, 0, 6);
			this.m_pnlCharacterAndDeliverySelection.Controls.Add(this.m_pnlDeliveryFilter, 0, 4);
			this.m_pnlCharacterAndDeliverySelection.Controls.Add(this.m_btnAddDelivery, 1, 4);
			this.m_pnlCharacterAndDeliverySelection.Controls.Add(this.m_btnAddCharacter, 1, 1);
			this.m_pnlCharacterAndDeliverySelection.Controls.Add(this.m_listBoxDeliveries, 0, 5);
			this.m_pnlCharacterAndDeliverySelection.Controls.Add(this.m_pnlCharacterFilter, 0, 1);
			this.m_pnlCharacterAndDeliverySelection.Controls.Add(this.m_lblDelivery, 0, 3);
			this.m_pnlCharacterAndDeliverySelection.Controls.Add(this.m_listBoxCharacters, 0, 2);
			...
			this.m_pnlCharacterAndDeliverySelection.Location = new System.Drawing.Point(12, 12);
			...
			this.m_pnlCharacterAndDeliverySelection.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 20F));
			this.m_pnlCharacterAndDeliverySelection.Size = new System.Drawing.Size(462, 385);
			this.m_pnlCharacterAndDeliverySelection.TabIndex = 30;
			// 
			// m_lblCharacter
			// 
			...
			this.l10NSharpExtender1.SetLocalizableToolTip(this.m_lblCharacter, null);
			this.l10NSharpExtender1.SetLocalizationComment(this.m_lblCharacter, null);
			this.l10NSharpExtender1.SetLocalizingId(this.m_lblCharacter, "AddCharacter.m_lblCharacter");
			this.m_lblCharacter.Location = new System.Drawing.Point(3, 0);
			...
			this.m_lblCharacter.TabIndex = 7;
			...
			this.l10NSharpExtender1.SetLocalizableToolTip(this.m_llMoreDel, null);
			this.l10NSharpExtender1.SetLocalizationComment(this.m_llMoreDel, null);
			this.l10NSharpExtender1.SetLocalizingId(this.m_llMoreDel, "AddCharacter.m_llMoreDel");
			this.m_llMoreDel.Location = new System.Drawing.Point(3, 352);
			...
			this.m_pnlDeliveryFilter.Location = new System.Drawing.Point(3, 232);
			this.m_pnlDeliveryFilter.Name = "m_pnlDeliveryFilter";
			this.m_pnlDeliveryFilter.Size = new System.Drawing.Size(436, 21);
			...
			this.tableLayoutPanelDelivery.Size = new System.Drawing.Size(432, 17);
			...
			this.l10NSharpExtender1.SetLocalizableToolTip(this.m_icnDeliveryFilter, null);
			this.l10NSharpExtender1.SetLocalizationComment(this.m_icnDeliveryFilter, null);
			this.l10NSharpExtender1.SetLocalizingId(this.m_icnDeliveryFilter, "AddCharacter.m_icnDeliveryFilter");
			this.m_icnDeliveryFilter.Location = new System.Drawing.Point(414, 0);
			...
			this.l10NSharpExtender1.SetLocalizableToolTip(this.m_txtDeliveryFilter, null);
			this.l10NSharpExtender1.SetLocalizationComment(this.m_txtDeliveryFilter, null);
			this.l10NSharpExtender1.SetLocalizingId(this.m_txtDeliveryFilter, "AddCharacter.m_txtDeliveryFilter");
			...
			this.m_txtDeliveryFilter.Size = new System.Drawing.Size(414, 13);
			this.m_txtDeliveryFilter.TabIndex = 0;
			...
			this.l10NSharpExtender1.SetLocalizableToolTip(this.m_btnAddDelivery, null);
			this.l10NSharpExtender1.SetLocalizationComment(this.m_btnAddDelivery, null);
			this.l10NSharpExtender1.SetLocalizingId(this.m_btnAddDelivery, "AddCharacter.m_btnAddDelivery");
			this.m_btnAddDelivery.Location = new System.Drawing.Point(442, 232);
			...
			this.m_btnAddDelivery.TabIndex = 5;
			...
			this.l10NSharpExtender1.SetLocalizableToolTip(this.m_btnAddCharacter, null);
			this.l10NSharpExtender1.SetLocalizationComment(this.m_btnAddCharacter, null);
			this.l10NSharpExtender1.SetLocalizingId(this.m_btnAddCharacter, "AddCharacter.m_btnAddCharacter");
			this.m_btnAddCharacter.Location = new System.Drawing.Point(442, 29);
			...
			this.m_btnAddCharacter.TabIndex = 4;
			...
			this.m_listBoxDeliveries.Location = new System.Drawing.Point(3, 259);
			this.m_listBoxDeliveries.Name = "m_listBoxDeliveries";
			this.m_listBoxDeliveries.Size = new System.Drawing.Size(456, 90);
			this.m_listBoxDeliveries.TabIndex = 3;
			...
			this.m_pnlCharacterFilter.Location = new System.Drawing.Point(3, 29);
			this.m_pnlCharacterFilter.Name = "m_pnlCharacterFilter";
			this.m_pnlCharacterFilter.Size = new System.Drawing.Size(436, 21);
			...
			this.tableLayoutPanelCharacter.Size = new System.Drawing.Size(432, 17);
			...
			this.l10NSharpExtender1.SetLocalizableToolTip(this.m_icnCharacterFilter, null);
			this.l10NSharpExtender1.SetLocalizationComment(this.m_icnCharacterFilter, null);
			this.l10NSharpExtender1.SetLocalizingId(this.m_icnCharacterFilter, "AddCharacter.m_icnCharacterFilter");
			this.m_icnCharacterFilter.Location = new System.Drawing.Point(414, 0);
			...
			this.l10NSharpExtender1.SetLocalizableToolTip(this.m_txtCharacterFilter, null);
			this.l10NSharpExtender1.SetLocalizationComment(this.m_txtCharacterFilter, null);
			this.l10NSharpExtender1.SetLocalizingId(this.m_txtCharacterFilter, "AddCharacter.m_txtCharacterFilter");
			...
			this.m_txtCharacterFilter.Size = new System.Drawing.Size(414, 13);
			this.m_txtCharacterFilter.TabIndex = 0;
			...
			this.l10NSharpExtender1.SetLocalizableToolTip(this.m_lblDelivery, null);
			this.l10NSharpExtender1.SetLocalizationComment(this.m_lblDelivery, null);
			this.l10NSharpExtender1.SetLocalizingId(this.m_lblDelivery, "AddCharacter.m_lblDelivery");
			this.m_lblDelivery.Location = new System.Drawing.Point(3, 206);
			...
			this.m_listBoxCharacters.Location = new System.Drawing.Point(3, 56);
			this.m_listBoxCharacters.Name = "m_listBoxCharacters";
			this.m_listBoxCharacters.Size = new System.Drawing.Size(456, 147);
			this.m_listBoxCharacters.TabIndex = 1;
			...
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
			this.tableLayoutPanel1.Controls.Add(this.m_btnCancel, 1, 0);
			this.tableLayoutPanel1.Controls.Add(this.m_btnOk, 0, 0);
			...
			this.l10NSharpExtender1.PrefixForNewItems = "DialogBoxes.AddCharacterDlg";
			// 
			// AddCharacterDlg
			// 
			...
			this.Controls.Add(this.m_pnlCharacterAndDeliverySelection);
			this.Controls.Add(this.tableLayoutPanel1);
			this.l10NSharpExtender1.SetLocalizableToolTip(this, null);
			this.l10NSharpExtender1.SetLocalizationComment(this, null);
			this.l10NSharpExtender1.SetLocalizingId(this, "AddCharacter.WindowTitle");
			this.Name = "AddCharacterDlg";
			this.Padding = new System.Windows.Forms.Padding(12);
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Add Character or Delivery";
