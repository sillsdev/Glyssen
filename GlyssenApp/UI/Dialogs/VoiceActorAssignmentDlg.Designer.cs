...
namespace GlyssenApp.UI.Dialogs
{
	partial class VoiceActorAssignmentDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.VoiceActorCol = new DataGridViewMultiColumnComboBoxColumn();
			...
			this.dataGridViewMultiColumnComboBoxColumn1 = new DataGridViewMultiColumnComboBoxColumn();
			this.glyssenColorPalette = new GlyssenColorPalette();
			this.m_lblMatches = new System.Windows.Forms.ToolStripLabel();
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.m_contextMenuCharacters, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_contextMenuCharacters, GlyssenColors.Default);
        ...
        "rs");
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.m_menuItemAssignToCameoActor, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_menuItemAssignToCameoActor, GlyssenColors.ForeColor);
			this.m_menuItemAssignToCameoActor.Image = global::GlyssenApp.Properties.Resources.CameoStar;
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.m_cameoActorToolStripMenuItem, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_cameoActorToolStripMenuItem, GlyssenColors.ForeColor);
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.m_menuItemMoveToAnotherGroup, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_menuItemMoveToAnotherGroup, GlyssenColors.ForeColor);
			this.m_menuItemMoveToAnotherGroup.Image = global::GlyssenApp.Properties.Resources.MoveArrow;
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.m_contextMenuCharacterGroups, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_contextMenuCharacterGroups, GlyssenColors.Default);
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.m_unAssignActorFromGroupToolStripMenuItem, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_unAssignActorFromGroupToolStripMenuItem, GlyssenColors.ForeColor);
			this.m_unAssignActorFromGroupToolStripMenuItem.Image = global::GlyssenApp.Properties.Resources.RemoveActor;
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.m_splitGroupToolStripMenuItem, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_splitGroupToolStripMenuItem, GlyssenColors.ForeColor);
			this.m_splitGroupToolStripMenuItem.Image = global::GlyssenApp.Properties.Resources.splitGroup;
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.m_AddCharacterToGroupToolStripMenuItem, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_AddCharacterToGroupToolStripMenuItem, GlyssenColors.ForeColor);
			this.m_AddCharacterToGroupToolStripMenuItem.Image = global::GlyssenApp.Properties.Resources.AddCharacter;
			...
			// m_undoButton
			// 
			this.glyssenColorPalette.SetBackColor(this.m_undoButton, GlyssenColors.BackColor);
			this.m_undoButton.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
			this.m_undoButton.Enabled = false;
			this.glyssenColorPalette.SetForeColor(this.m_undoButton, GlyssenColors.ForeColor);
			this.m_undoButton.Image = global::GlyssenApp.Properties.Resources.undo;
			...
			// m_redoButton
			// 
			this.glyssenColorPalette.SetBackColor(this.m_redoButton, GlyssenColors.BackColor);
			this.m_redoButton.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
			this.m_redoButton.Enabled = false;
			this.glyssenColorPalette.SetForeColor(this.m_redoButton, GlyssenColors.ForeColor);
			this.m_redoButton.Image = global::GlyssenApp.Properties.Resources.redo;
			...
			this.glyssenColorPalette.SetBackColor(this.m_editActorsButton, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_editActorsButton, GlyssenColors.ForeColor);
			this.m_editActorsButton.Image = global::GlyssenApp.Properties.Resources.people;
			...
			this.glyssenColorPalette.SetBackColor(this.m_splitSelectedGroupButton, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_splitSelectedGroupButton, GlyssenColors.ForeColor);
			this.m_splitSelectedGroupButton.Image = global::GlyssenApp.Properties.Resources.splitGroup;
			...
			// toolStripSeparator2
			// 
			this.glyssenColorPalette.SetBackColor(this.toolStripSeparator2, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.toolStripSeparator2, GlyssenColors.ForeColor);
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.m_toolStripLabelFindCharacter, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_toolStripLabelFindCharacter, GlyssenColors.ForeColor);
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.m_toolStripTextBoxFindCharacter, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_toolStripTextBoxFindCharacter, GlyssenColors.ForeColor);
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.m_toolStripButtonFindNextMatchingCharacter, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_toolStripButtonFindNextMatchingCharacter, GlyssenColors.ForeColor);
			this.m_toolStripButtonFindNextMatchingCharacter.Image = global::GlyssenApp.Properties.Resources.search_glyph;
			...
			this.glyssenColorPalette.SetBackColor(this.m_characterDetailsGrid, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_characterDetailsGrid, GlyssenColors.ForeColor);
    ...
    " ID";
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblMovePendingInfo, GlyssenColors.BackColor);
			this.m_tableLayoutPanelMove.SetColumnSpan(this.m_lblMovePendingInfo, 2);
			this.glyssenColorPalette.SetForeColor(this.m_lblMovePendingInfo, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_btnCancelMove, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_btnCancelMove, GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetForeColor(this.m_btnCancelMove, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_btnMove, GlyssenColors.BackColor);
			this.m_btnMove.Enabled = false;
			this.glyssenColorPalette.SetFlatAppearanceBorderColor(this.m_btnMove, GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetForeColor(this.m_btnMove, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblMoveInstr, GlyssenColors.BackColor);
			this.m_tableLayoutPanelMove.SetColumnSpan(this.m_lblMoveInstr, 2);
			this.glyssenColorPalette.SetForeColor(this.m_lblMoveInstr, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetActiveLinkColor(this.m_linkLabelShowHideDetails, GlyssenColors.ActiveLinkColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_linkLabelShowHideDetails, GlyssenColors.BackColor);
			this.m_linkLabelShowHideDetails.BackColor = System.Drawing.SystemColors.Control;
			this.glyssenColorPalette.SetDisabledLinkColor(this.m_linkLabelShowHideDetails, GlyssenColors.DisabledLinkColor);
			this.m_linkLabelShowHideDetails.DisabledLinkColor = System.Drawing.Color.FromArgb(((int)(((byte)(133)))), ((int)(((byte)(133)))), ((int)(((byte)(133)))));
			this.glyssenColorPalette.SetForeColor(this.m_linkLabelShowHideDetails, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetLinkColor(this.m_linkLabelShowHideDetails, GlyssenColors.LinkColor);
			...
			this.glyssenColorPalette.SetVisitedLinkColor(this.m_linkLabelShowHideDetails, GlyssenColors.VisitedLinkColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_characterGroupGrid, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_characterGroupGrid, GlyssenColors.ForeColor);
    ...
    "d";
			...
			// m_menuStrip
			// 
			this.glyssenColorPalette.SetBackColor(this.m_menuStrip, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_menuStrip, GlyssenColors.Default);
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.fileToolStripMenuItem, GlyssenColors.BackColor);
			this.fileToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.saveAsToolStripMenuItem,
            this.printToolStripMenuItem});
			this.glyssenColorPalette.SetForeColor(this.fileToolStripMenuItem, GlyssenColors.ForeColor);
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.saveAsToolStripMenuItem, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.saveAsToolStripMenuItem, GlyssenColors.ForeColor);
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.printToolStripMenuItem, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.printToolStripMenuItem, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.helpToolStripMenuItem, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.helpToolStripMenuItem, GlyssenColors.ForeColor);
			this.helpToolStripMenuItem.Image = global::GlyssenApp.Properties.Resources.helpSmall;
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.changeTheListOfGroupsToolStripMenuItem, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.changeTheListOfGroupsToolStripMenuItem, GlyssenColors.ForeColor);
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.adjustGroupsToMatchMyVoiceActorsToolStripMenuItem, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.adjustGroupsToMatchMyVoiceActorsToolStripMenuItem, GlyssenColors.ForeColor);
        ...
        "Item");
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.adjustVoiceActorListToolStripMenuItem, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.adjustVoiceActorListToolStripMenuItem, GlyssenColors.ForeColor);
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.adjustCastSizePlanToolStripMenuItem, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.adjustCastSizePlanToolStripMenuItem, GlyssenColors.ForeColor);
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.manuallyEditGroupshelpToolStripMenuItem, GlyssenColors.BackColor);
			this.manuallyEditGroupshelpToolStripMenuItem.Enabled = false;
			this.glyssenColorPalette.SetForeColor(this.manuallyEditGroupshelpToolStripMenuItem, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblFewerOrMore, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_lblFewerOrMore, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetActiveLinkColor(this.m_linkVoiceActorList, GlyssenColors.ActiveLinkColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_linkVoiceActorList, GlyssenColors.BackColor);
			this.m_linkVoiceActorList.BackColor = System.Drawing.SystemColors.Control;
			this.glyssenColorPalette.SetDisabledLinkColor(this.m_linkVoiceActorList, GlyssenColors.DisabledLinkColor);
			this.m_linkVoiceActorList.DisabledLinkColor = System.Drawing.Color.FromArgb(((int)(((byte)(133)))), ((int)(((byte)(133)))), ((int)(((byte)(133)))));
			this.glyssenColorPalette.SetForeColor(this.m_linkVoiceActorList, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetLinkColor(this.m_linkVoiceActorList, GlyssenColors.LinkColor);
			...
			this.glyssenColorPalette.SetVisitedLinkColor(this.m_linkVoiceActorList, GlyssenColors.VisitedLinkColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblInstructions2, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_lblInstructions2, GlyssenColors.ForeColor);
    ...
    "";
			...
			this.glyssenColorPalette.SetActiveLinkColor(this.m_linkClose, GlyssenColors.ActiveLinkColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_linkClose, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetDisabledLinkColor(this.m_linkClose, GlyssenColors.DisabledLinkColor);
			this.m_linkClose.ForeColor = System.Drawing.SystemColors.WindowText;
			this.glyssenColorPalette.SetForeColor(this.m_linkClose, GlyssenColors.ForeColor);
			this.glyssenColorPalette.SetLinkColor(this.m_linkClose, GlyssenColors.LinkColor);
			...
			this.glyssenColorPalette.SetVisitedLinkColor(this.m_linkClose, GlyssenColors.VisitedLinkColor);
			...
			this.glyssenColorPalette.SetActiveLinkColor(this.m_linkPrint, GlyssenColors.ActiveLinkColor);
			this.m_linkPrint.AutoSize = true;
			this.glyssenColorPalette.SetBackColor(this.m_linkPrint, GlyssenColors.BackColor);
			this.m_linkPrint.BackColor = System.Drawing.SystemColors.Control;
			this.glyssenColorPalette.SetDisabledLinkColor(this.m_linkPrint, GlyssenColors.DisabledLinkColor);
			this.m_linkPrint.DisabledLinkColor = System.Drawing.Color.FromArgb(((int)(((byte)(133)))), ((int)(((byte)(133)))), ((int)(((byte)(133)))));
			this.glyssenColorPalette.SetForeColor(this.m_linkPrint, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetLinkColor(this.m_linkPrint, GlyssenColors.LinkColor);
        ...
        "lg.Instructions.Line1.LinkText");
			...
			this.glyssenColorPalette.SetVisitedLinkColor(this.m_linkPrint, GlyssenColors.VisitedLinkColor);
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.glyssenColorPalette.SetBackColor(this.m_tableLayoutPanel, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_tableLayoutPanel, GlyssenColors.Default);
			...
			this.glyssenColorPalette.SetBackColor(this.m_tableLayoutPanelLowerRight, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_tableLayoutPanelLowerRight, GlyssenColors.Default);
			...
			this.glyssenColorPalette.SetBackColor(this.m_tableLayoutPanelMove, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_tableLayoutPanelMove, GlyssenColors.Default);
			...
			this.glyssenColorPalette.SetBackColor(this.m_tableLayoutPanelVoiceActorList, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_tableLayoutPanelVoiceActorList, GlyssenColors.Default);
    ...
    "d";
			...
			// m_lblMatches
			// 
			this.glyssenColorPalette.SetBackColor(this.m_lblMatches, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_lblMatches, GlyssenColors.ForeColor);
			this.m_l10NSharpExtender.SetLocalizableToolTip(this.m_lblMatches, null);
			this.m_l10NSharpExtender.SetLocalizationComment(this.m_lblMatches, null);
			this.m_l10NSharpExtender.SetLocalizationPriority(this.m_lblMatches, L10NSharp.LocalizationPriority.NotLocalizable);
			this.m_l10NSharpExtender.SetLocalizingId(this.m_lblMatches, "DialogBoxes.VoiceActorAssignmentDlg.m_lblMatches");
			this.m_lblMatches.Name = "m_lblMatches";
			this.m_lblMatches.Size = new System.Drawing.Size(100, 22);
			this.m_lblMatches.Text = "{0} of {1} matches";
			this.glyssenColorPalette.SetUsePaletteColors(this.m_lblMatches, false);
			// 
		...
		private ToolStripLabel m_lblMatches;
	}
}