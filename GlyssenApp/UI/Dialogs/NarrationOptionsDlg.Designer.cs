...
namespace GlyssenApp.UI.Dialogs
{
	partial class NarrationOptionsDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblExplanatory, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_lblExplanatory, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblDesiredMaleNarratorNum, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_lblDesiredMaleNarratorNum, GlyssenColors.ForeColor);
			...
			// 
			this.glyssenColorPalette.SetBackColor(this.m_selectionsTableLayout, GlyssenColors.BackColor);
			...
			this.glyssenColorPalette.SetForeColor(this.m_selectionsTableLayout, GlyssenColors.Default);
			...
			this.glyssenColorPalette.SetBackColor(this.m_numMaleNarrator, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_numMaleNarrator, GlyssenColors.Default);
			...
			this.glyssenColorPalette.SetBackColor(this.m_lblDesiredFemaleNarratorNum, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_lblDesiredFemaleNarratorNum, GlyssenColors.ForeColor);
			...
			this.glyssenColorPalette.SetBackColor(this.m_numFemaleNarrator, GlyssenColors.BackColor);
			this.glyssenColorPalette.SetForeColor(this.m_numFemaleNarrator, GlyssenColors.Default);
